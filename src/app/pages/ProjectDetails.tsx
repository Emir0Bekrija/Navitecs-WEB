        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 w-full">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              <span className="px-3 py-1 text-xs font-medium bg-gradient-to-r from-[#00AEEF] to-[#00FF9C] text-black font-semibold rounded-lg">
                {project.category}
              </span>
            </div>
      ...
      <section className="py-16 -mt-10 relative z-30">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            >
              <h2 className="text-2xl font-semibold mb-6 flex items-center">
                <span className="bg-gradient-to-r from-[#00AEEF] to-[#00FF9C] w-1.5 h-6 mr-3 rounded-full"></span>
                The Challenge
              </h2>
            ...
            >
               <h2 className="text-2xl font-semibold mb-6 flex items-center">
                <span className="bg-gradient-to-r from-[#00FF9C] to-[#00AEEF] w-1.5 h-6 mr-3 rounded-full"></span>
                Impact & Results
              </h2>
              <div className="grid gap-4 sm:grid-cols-2">
                {project.caseStudy?.results.map((result, idx) => (
                   <div key={idx} className="bg-white/5 border border-white/10 p-5 rounded-xl flex items-start gap-3">
          ...
          <div className="space-y-6">
            ...
            >
              <h3 className="text-lg font-semibold mb-4 border-b border-white/10 pb-4">Project Overview</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="text-sm text-gray-500 uppercase tracking-wider mb-1">Scope of Work</p>
                  <p className="text-white">{project.scope}</p>
                </div>
              </div>
              
              <div className="mt-8 pt-6 border-t border-white/10">
                <button className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg transition-colors text-white text-sm font-medium">
      ...
      <section className="py-24 mt-12 bg-white/5">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Partner with us to bring your vision to life through innovative BIM coordination and engineering solutions.
            </p>
            <Link
              to="/contact"
